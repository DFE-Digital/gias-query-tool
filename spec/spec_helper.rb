...
module OpenAPISpecVerifier
  def be_valid_against_openapi_schema(schema)
    spec = YAML.load_file('config/gias_api_v1.yml')
    OpenAPI3::ValidAgainstOpenAPISchemaMatcher.new(schema, spec)
  end
end
...
RSpec.configure do |config|
  ...
  config.include OpenAPISpecVerifier
